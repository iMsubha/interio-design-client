      ...
      >
        <div className="d-flex">
          <div className="d-flex flex-column mr-3">
            ...
            />
            {errors.title && <p className="errorText">Please give a valid Service Name</p>}
          </div>
        ...
        <div className="d-flex">
          ...
          <input
            onChange={handleImageUpload}
             ...
             accept="image/*"
            />
          <label for="file"  className="upload-image font-weight-bold"><AddPhotoAlternateRoundedIcon></AddPhotoAlternateRoundedIcon> Upload Image</label>  
          </div>
        </div>
